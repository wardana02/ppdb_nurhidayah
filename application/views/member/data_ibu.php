...
<div class="alert alert-dismissable alert-success">
  ...
  <div class="pull-right">
    <a href="<?php echo site_url().'member/data_alamat' ?>" class="btn btn-xs glyphicon glyphicon-forward"> LANJUT </a>
  </div>
</div>
<?php } ?>

<div class="well">
<form name="pendaftaran" method="POST" action="<?php echo site_url().'member/update_dataibu' ?>" class="form-horizontal">
  <fieldset>
