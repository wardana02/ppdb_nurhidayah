...
class Pendaftaran_mdl extends CI_Model
{
    ...
    function validasi()
    {
        $validasi = array(
                        ...
                        array('field'=>'nohp', 'label'=>'Nomor HP', 'rules'=>'trim|required|numeric|min_length[10]|max_length[14]|is_unique[data_account.nohp]|is_unique[data_siswa.nohp]|xss_clean'),
    ...
    function simpan()
    {
        ...
        $data = array('namalengkap'=>$this->input->post('namalengkap'),
                      ...
                      'password'=>$this->password($this->input->post('tahun'), $this->input->post('tanggal')),
                      'tgldaftar'=>date('Y-m-d'),
                      'jamdaftar'=>date('H:i:s'),
                      'kd_unik'=>$this->kd_unik()
                      );
        $unik = array('kd_unik'=>$this->kd_unik());
        $this->db->trans_start();
